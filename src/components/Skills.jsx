...
const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: "JavaScript",  icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg", level: 82 },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Express.js",icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg",  level: 72 },
      ...
      { name: "Django",    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/django/django-plain.svg",       level: 65 },
    ],
  },
  {
